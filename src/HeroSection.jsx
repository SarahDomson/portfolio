...
<div className="flex flex-col lg:flex-row justify-center gap-5 items-center mb-10">
      <div className="pr-4 pt-12 md:px-12 lg:px-2">
        <img src ="src/assets/images/Avatar.svg" alt="avatar" className="w-full h-full rounded-full " />
      </div>
...
<div className="flex justify-center gap-10 items-center">
      ...
      <div>
        <img src="src/assets/images/css-logo.png" alt="CSS" className="md:w-24 h-24"/>
      </div>

      <div>
        <img src="src/assets/images/react.png" alt="React"className="md:w-24 h-24"/>
      </div>

    <div>
        <img src="src/assets/images/Tailwind CSS.png" alt="Tailwind CSS" className="md:w-24 h-24"/>
    </div>
    </div>
    </div>
    </div>
    ...
    <ul className="flex gap-2 md:gap-10">
      <li>
        <a href="https://github.com/SarahDomson" target="_blank">
          <img src="src/assets/images/github.png" alt="GitHub" className="w-10 h-10 md:w-16 md:h-16 transform transition-transform duration-300 hover:translate-x-2 hover:translate-y-2"/>
        </a>
      </li>
      <li>
        <a href="https://x.com/Ama_Domson?t=uxkbnLiauun68q9yfsxVRw&s=09" target="_blank">
          <img src="src/assets/images/X logo.png" alt="X" className="w-10 h-10 md:w-16 md:h-16 transform transition-transform duration-300 hover:translate-x-2 hover:translate-y-2"/>
        </a>
      </li>
      <li>
        <a href="https://www.linkedin.com/in/sarah-domson-5749661a9?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
          <img src="src/assets/images/linkedin.png" alt="LinkedIn" className="w-10 h-10 md:w-16 md:h-16 transform transition-transform duration-300 hover:translate-x-2 hover:translate-y-2"/>
        </a>
      </li>
      <li>
        <a href="https://stackoverflow.com/users/20094295/sarah-domson" target="_blank">
          <img src="src/assets/images/stackoverflow.png" alt="Stack Overflow" className="w-10 h-10 md:w-16 md:h-16 transform transition-transform duration-300 hover:translate-x-2 hover:translate-y-2"/>
        </a>
      </li>
    </ul>
  </nav>
